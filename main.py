...
game_label = tk.Label(root, text="Gato", font='normal 30 bold', bg='#263238', fg='white')
...
rest_button = tk.Button(root, text='Reiniciar', font='normal 15 bold', command=reset_game, bg='#546E7A', fg='white')
rest_button.place(relx=0.5, rely=0.9, anchor='center')
